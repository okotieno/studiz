...
// Add a new record under "paths"
  ...
  jsonData.compilerOptions.paths[`@studiz/backend/${fileName}-backend-service`] = [`libs/backend/services/${fileName}/src/index.ts`];
  jsonData.compilerOptions.paths[`@studiz/backend/${fileName}-backend`] = [`libs/backend/${fileName}/src/index.ts`];
